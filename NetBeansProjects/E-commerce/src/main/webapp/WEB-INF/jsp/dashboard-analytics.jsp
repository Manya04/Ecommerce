<%-- 
    ...
    Created on : 24-Mar-2021, 11:27:33 pm
    Author     : manyaagarwal
--%>
...
<html>
    ...
    <title>Dashboard analytics - Vuexy</title>
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                            ...
                            <div class="card bg-analytics text-white">
                                <div class="card-content">
                                    <div class="card-body text-center">
                                        <img src="${cp}/home/app-assets/images/elements/decore-left.png" class="img-left" alt="
            card-img-left">
                                        <img src="${cp}/home/app-assets/images/elements/decore-right.png" class="img-right" alt="
            card-img-right">
                                        ...
                                        <div class="text-center">
                                            <h1 class="mb-2 text-white">Congratulations ${customer.name},</h1>
    ...
    <script src="${cp}/home/app-assets/vendors/js/charts/apexcharts.min.js"></script>
    <script src="${cp}/home/app-assets/vendors/js/extensions/tether.min.js"></script>
    <script src="${cp}/home/app-assets/vendors/js/extensions/shepherd.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="${cp}/home/app-assets/js/scripts/pages/dashboard-analytics.js"></script>
    <!-- END: Page JS-->
