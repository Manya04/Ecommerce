<%-- 
    Document   : dashboard-ecommerce
    Created on : 25-Mar-2021, 12:01:20 am
    Author     : manyaagarwal
--%>
...
<html>
    ...
    <title>Dashboard ecommerce - Vuexy</title>
    ...
    <link rel="stylesheet" type="text/css" href="${cp}/home/app-assets/css/pages/dashboard-ecommerce.css">
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                                            ...
                                            <div class="chat">
                                                <div class="chat-avatar">
                                                    <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                                        <img src="${cp}/home/app-assets/images/portrait/small/avatar-s-2.jpg" alt="avatar" height="40" width="40" />
                                                    </a>
                                                </div>
                                                <div class="chat-body">
                                            ...
                                            <div class="chat chat-left">
                                                <div class="chat-avatar mt-50">
                                                    <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                                        <img src="${cp}/home/app-assets/images/portrait/small/avatar-s-5.jpg" alt="avatar" height="40" width="40" />
                                                    </a>
                                                </div>
                                                <div class="chat-body">
                                                    <div class="chat-content">
    ...
    <!-- BEGIN: Page JS-->
    <script src="${cp}/home/app-assets/js/scripts/pages/dashboard-ecommerce.js"></script>
    <!-- END: Page JS-->
