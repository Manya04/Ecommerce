<%-- 
    Document   : login
    Created on : 01-Apr-2021, 4:29:15 pm
    Author     : manyaagarwal
--%>
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="${cp}/home/app-assets/images/pages/login.png" alt="branding logo">
                                </div>
                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form id="add-event-form" action="signIn" method="post">
                                                    ...
                                                    <a href="index" class="btn btn-outline-primary float-left btn-inline">Register</a>
...
//            dataType    : 'json',
            timeout: 600000
                 ...
                 if(response === "loginSuccessful"){
                    ...
                    alert(response);
                }else if(response === "loginUnsuccessful"){
