<%-- 
    Document   : SignIn
    Created on : 07-Mar-2021, 8:17:53 pm
    Author     : manyaagarwal
--%>
                                    ...
                                    <div class="card rounded-0 mb-0 p-2">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form id="add-event-form" action="signUp" method="post">
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="password" id="inputConfPassword" class="form-control" name="confirmPassword" placeholder="Confirm Password" required>
                                                    ...
                                                    <button type="submit" id="submit-btn" class="btn btn-primary float-right btn-inline mb-50">Register</button>
                                                </form>
                                    </div>
                                </div>
                            </div>
...
//            dataType    : 'json',
            timeout: 600000
                 ...
                 if(response === "customer added"){
                    window.location.href = "/E-commerce/dashboard-analytics";
                }else if(response === "Could'nt Add. Try again."){
                    window.location.href = "/E-commerce/index";
                    alert(response);
                }else if(response === "paaswords do not match"){
                    window.location.href = "/E-commerce/index";
                    alert(response);
                }
                 console.log(response);
