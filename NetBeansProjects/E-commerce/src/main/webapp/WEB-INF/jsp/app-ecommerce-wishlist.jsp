<%-- 
    Document   : app-ecommerce-wishlist
    Created on : 16-Apr-2021, 1:03:54 am
    Author     : manyaagarwal
--%>
...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="${cp}/home/app-assets/css/pages/app-ecommerce-shop.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern 2-columns ecommerce-application navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                ...
                <section id="wishlist" class="grid-view wishlist-items">
                        ...
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/1.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/2.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/3.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/4.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
                                ...
                                <div class="item-name">
                                    <a href="app-ecommerce-details.html">
                                        Garmin - f?nix 5 GPS Heart Rate Monitor Watch - Slate gray
                                    </a>
                                </div>
                                <div>
                                    <p class="item-description">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/5.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/6.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/7.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/8.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/9.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/10.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                            <div class="item-img text-center">
                                <a href="app-ecommerce-details.html">
                                    <img src="${cp}/home/app-assets/images/pages/eCommerce/11.png" class="img-fluid" alt="img-placeholder">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="item-wrapper">
    ...
    <!-- BEGIN: Page JS-->
    <script src="${cp}/home/app-assets/js/scripts/pages/app-ecommerce-shop.js"></script>
    <!-- END: Page JS-->
